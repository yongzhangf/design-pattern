 ...
 * 它跟【初始加载】方式不同的是：【初始加载】方式只要 Singleton 类被装载了，
 ...
 * 这个时候，这种方式相比【初始加载】方式就显得很合理。
 */
public class SingletonIC extends BaseSingleton {

    private static class SingletonHolder {
        private static final SingletonIC INSTANCE = new SingletonIC();
    }
    ...
    public static SingletonIC getInstance() {
