...
public class AbstractFactoryPatternDemo {
    ...
    public static void main(String[] args) {
        ...
        Keybo keybo = dellPcFactory.createKeybo();
        Mouse mouse = dellPcFactory.createMouse();

        keybo.getEquipmentInfo();
        keybo.type();

        mouse.getEquipmentInfo();
        mouse.move();

        PcFactory hpPcFactory = FactoryProducer.getFactory("Hp");

        keybo = hpPcFactory.createKeybo();
        mouse = hpPcFactory.createMouse();
